...
\section{Dok³adny test dla zbiorów - algorytm BSP tree}

Jedn± z najbardziej wszechstronnych metod dok³adnego rozwi±zywania kolizji jest \textbf{Binary Space-Partitioning tree} (w skrócie BSP tree), któr± te¿ zaimplementowana w aplikacji.

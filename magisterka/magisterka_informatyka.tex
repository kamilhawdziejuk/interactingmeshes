...
1.	\textbf{Reprezentacja obiektów w aplikacji}.
Wybrana reprezentacja geometryczna dla sceny oraz pojawiaj±cych siê w niej obiektów wp³ywa w oczywisty sposób na algorytmy wykrywaj±ce w niej kolizje.  W szczególno¶ci dla reprezentacji z mniejszymi wymogami zaprojektowany  mo¿e byæ bardziej ogólny system. W kolejnym rozdziale bardziej szczegó³owo przybli¿one zostan± sposoby przedstawiania obiektów w  scenie. W niniejszej pracy najbardziej skupimy siê na powszechnie wykorzystywanych obecnie siatkach trók±tów.

2.	\textbf{Ró¿ne rodzaje zapytañ o kolizje}.
...
6.	\textbf{£atwo¶æ implementacji i prostota u¿ytkowania}.
Wiêkszo¶æ projektów jest ograniczona czasowo. 
...
Obiekty takie w grafice komputerowej  bardzo czêsto reprezentowane s± w postaci przybli¿onej. Istniej± specjalne algorytmy triangulacji, których zadanie polega na rozbiciu bardziej z³o¿onych obiektów na siatki trójk±tów, które je pokrywaj±. W procesie tym powstaje wielok±t (wielo¶cian), który jest mo¿liwie bliskim przybli¿eniem danego obiektu. Warto w tym miejscu wspomnieæ, ¿e triangulacja wspierana jest coraz bardziej ze strony sprzêtowej i ze wzglêdów wydajno¶ciowych zajmuj± siê tym obecnie pozdespo³y graficzne ju¿ w procesie renderowania. Dlatego te¿ w systemach kolizji równie¿ najczê¶ciej wybieran± reprezentacj± jest siatka wielok±tów (przewa¿nie trójk±tów) reprezentuj±cych obiekt z przestrzenii. 

W zwi±zku z tym naszym naturalnym za³o¿eniem w dalszej czê¶ci pracy jest to, ¿e wszystkie analizowane obiekty s± wielo¶cianami, a ka¿dy z nich utworzony jest z:
